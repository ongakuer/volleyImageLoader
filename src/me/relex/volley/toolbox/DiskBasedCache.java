...
/**
 * Cache implementation that caches files directly onto the hard disk in
 * the specified
...
public class DiskBasedCache implements Cache {
    ...
    /**
     * Constructs an instance of the DiskBasedCache at the specified
     * directory.
     * 
    ...
    /**
     * Initializes the DiskBasedCache by scanning for all files currently
     * in the
     ...
     * 
     * @param key Cache key
     * @param fullExpire True to fully expire the entry, false to soft
     *        expire
     */
    @Override
    ...
    static class CacheHeader {
        ...
        /**
         * The size of the data identified by this CacheHeader. (This is
         * not
         * serialized to disk.
         */
        public long size;
